...
function of_recognized_background_repeat() {
	$default = array(
		'no-repeat' => esc_html__( 'No Repeat', 'Thespis' ),
		'repeat-x'  => esc_html__( 'Repeat Horizontally', 'Thespis' ),
		'repeat-y'  => esc_html__( 'Repeat Vertically', 'Thespis' ),
		'repeat'    => esc_html__( 'Repeat All', 'Thespis' ),
		);
...
function of_recognized_background_position() {
	$default = array(
		'top left'      => esc_html__( 'Top Left', 'Thespis' ),
		'top center'    => esc_html__( 'Top Center', 'Thespis' ),
		'top right'     => esc_html__( 'Top Right', 'Thespis' ),
		'center left'   => esc_html__( 'Middle Left', 'Thespis' ),
		'center center' => esc_html__( 'Middle Center', 'Thespis' ),
		'center right'  => esc_html__( 'Middle Right', 'Thespis' ),
		'bottom left'   => esc_html__( 'Bottom Left', 'Thespis' ),
		'bottom center' => esc_html__( 'Bottom Center', 'Thespis' ),
		'bottom right'  => esc_html__( 'Bottom Right', 'Thespis')
		);
...
function of_recognized_background_attachment() {
	$default = array(
		'scroll' => esc_html__( 'Scroll Normally', 'Thespis' ),
		'fixed'  => esc_html__( 'Fixed in Place', 'Thespis')
		);
...
function of_recognized_font_styles() {
	$default = array(
		'normal'      => esc_html__( 'Normal', 'Thespis' ),
		'italic'      => esc_html__( 'Italic', 'Thespis' ),
		'bold'        => esc_html__( 'Bold', 'Thespis' ),
		'bold italic' => esc_html__( 'Bold Italic', 'Thespis' )
		);
