...
?>
		...
		<?php	do_action( 'Thespis_after_woocommerce' ); ?>
	...
	<div id="footercontainer">
		...
		<?php if ( of_get_option( 'footer_content', Thespis_get_credits() ) ) {
			echo '<div class="row smallprint">';
			echo apply_filters( 'meta_content', wp_kses_post( of_get_option( 'footer_content', Thespis_get_credits() ) ) );
			echo '</div> <!-- /.smallprint -->';
		} ?>
